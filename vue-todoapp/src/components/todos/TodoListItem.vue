<template>
    <div class="todo-list-item">
      <!-- View Mode -->
      <div v-if="!isEditing" class="todo-view-mode">
        ...
        <div class="todo-actions">
          ...
          <button @click="$emit('remove', todo.id)" class="btn-delete">Delete</button>
        </div>
      </div>
      
      <!-- Edit Mode -->
      <div v-else class="todo-edit-mode">
        <div class="edit-form">
          <input 
            type="text" 
            v-model="editedName" 
  ...
  const startEditing = () => {
    ...
    // Focus the input on next tick after the DOM updates
    nextTick(() => {
